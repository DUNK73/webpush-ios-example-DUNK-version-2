async function initServiceWorker() {
    let swRegistration = await navigator.serviceWorker.register('https://web-push-2-55d19.web.app/webpush-ios-example/serviceworker.js', {scope: '/webpush-ios-example/'})
